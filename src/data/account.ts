...
import type { AccountActivityItem, AccountBookSummary, AccountNotificationItem, AccountOrder, AccountProfile } from '@/src/types/account';

export const accountLibrary: AccountBookSummary[] = [
  {
    id: mockBooks[0].id,
...
export const accountPublishedBooks: AccountBookSummary[] = [
  {
    id: mockBooks[3].id,
    ...
    status: 'Live',
    progress: '512 sales • 4.9★',
  },
  {
    id: mockBooks[5].id,
    title: mockBooks[5].title,
    author: mockBooks[5].author,
    cover: mockBooks[5].cover,
    status: 'Draft',
    progress: 'Editing final chapter',
  },
  {
    id: mockBooks[7].id,
    title: mockBooks[7].title,
    author: mockBooks[7].author,
    cover: mockBooks[7].cover,
    status: 'Scheduled',
    progress: 'Launches next week',
  },
];
